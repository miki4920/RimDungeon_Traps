...
namespace RimDungeon
{
    public class JobDriver_RearmTrap : JobDriver
    {
        ...
        public static Thing FindShellForTrap(Pawn pawn, Trap_Framework trap)
        {
            ...
            return GenClosest.ClosestThingReachable(trap.Position, trap.Map, thingFilter.BestThingRequest, PathEndMode.OnCell, TraverseParms.For(pawn, Danger.Deadly, TraverseMode.ByPawn, false, false, false), 40f, validator, null, 0, -1, false, RegionType.Set_Passable, false);
        }
